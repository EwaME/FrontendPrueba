...
import { crearServicio, getServicios, actualizarServicio } from "../Servicios/api";
...
function Inicio() { 
  ...
  return ( 
    ...
    <div className="pagina">
      <h2 className="titulo">Servicios TI</h2>
      ...
      {filtrados.length === 0 && <p className="vacio">No hay resultados</p>}
